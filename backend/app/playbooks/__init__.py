...
BuyCall, Roll, Close or Hold -- that the app proposes and the user places,
or, in the simulated account with the switch on, the runner places itself.
...
script; poor_mans_wheel.py the second (a long call in place of the shares).
"""
