...
class RollRequest(BaseModel):
    ...
    ticket for the new position: a cash-secured put or covered call (the
    shapes a wheel rolls), a long call / long put (a poor man's wheel
    rolling its LEAPS out), or a vertical -- one side of a condor rolled
    out or away, which is how a condor is managed. `limit_net` is the net per package the roll
